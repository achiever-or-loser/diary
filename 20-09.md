...
```
//        CorsConfiguration options = new CorsConfiguration();
//        options.setAllowCredentials(Boolean.TRUE);
//        options.addAllowedOrigin("*");
//        options.addAllowedHeader("*");
//        options.addAllowedMethod("OPTIONS");
//        source.registerCorsConfiguration("/**",options);
```
