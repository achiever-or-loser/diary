...
=============失败的所有情况=============
失败日志量:515
/api/newStock/groupon/getUserGroup 180000 没开户 13
/api/newStock/groupon/getUserGroup 180009 已经参与其它正在进行的活动 1
/api/newStock/groupon/joinSelfGroup 180009 已经参与其它正在进行的活动 1



http://180.163.42.201:11000/logs/log_search_data/?server=758%40UnifiedLog%40EMIS_Data_Trade&devgroup=37&ip_type=1&ip_val=10.207.31.143%2C10.207.31.152%2C10.207.31.161%2C10.207.31.171&stat_time=2020/09/21 00:00:00 - 2020/09/21 23:59:59&sort_desc=1&dbmode=0&jm=0&chart_day=2020/09/21 00:00:00 - 2020/09/21 23:59:59&chart_unit=4&chart_trady=0&chart_limit=&tps_sort=time2&query_type=mytab1&u=tangxin&ctresult=-1,1,false,失败&limit=50&start=0&page=2&draw=19&_=1597192755618



http://180.163.42.201:11000/logs/log_search_data/?server=758%40UnifiedLog%40EMIS_Data_Trade&devgroup=37&ip_type=1&ip_val=10.207.31.143%2C10.207.31.152%2C10.207.31.161%2C10.207.31.171&stat_time=2020/09/01 00:00:00 - 2020/09/01 23:59:59&sort_desc=1&dbmode=0&jm=0&chart_day=2020/09/01 00:00:00 - 2020/09/01 23:59:59&chart_unit=4&chart_trady=0&chart_limit=&tps_sort=time2&query_type=mytab1&u=tangxin&ctresult=-1,1,false,失败&limit=29&start=0&page=1&draw=19&_=1597192755618
...
~~~
##基础数据部接口
address.api.data-account=http://61.152.230.66/databaseOfAccount/
address.api.data-trade=http://61.152.230.66/databaseOfTrade/
~~~

原来的Database Configuration和MyBatis Configuration可以删除

~~~
# Database Configuration
spring.datasource.druid.driver-class-name=oracle.jdbc.OracleDriver
spring.datasource.druid.url=jdbc:oracle:thin:@10.10.81.115:1521:XZTXKH
spring.datasource.druid.username=zqsmconf
spring.datasource.druid.password=OLs2ASLs
spring.datasource.druid.type=com.alibaba.druid.pool.DruidDataSource
# Database Configuration
second.datasource.druid.driver-class-name=oracle.jdbc.OracleDriver
second.datasource.druid.url=jdbc:oracle:thin:@10.10.83.79:1521:ORCL
second.datasource.druid.username=kfreader
second.datasource.druid.password=Fw3zc34s
second.datasource.druid.type=com.alibaba.druid.pool.DruidDataSource
# MyBatis Configuration
mybatis.mapper-locations=classpath:mapper/*.xml
~~~

原来的文章接口、入金指引接口、IPO接口、专题接口、统计接口中涉及到数据库操作的都有修改

## database.account项目：

账户关系控制器中增加根据custid获取柜台HKCuaccId

新增文章接口、银行订单、客户标签控制器、专题接口、统计接口相关控制器



## database.trade项目：

在新股信息控制器增加通过证券代码获取申购时间接口
